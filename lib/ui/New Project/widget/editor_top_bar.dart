...
class EditorTopBar extends StatelessWidget {
        ...
        child: Padding(
          ...
          child: Row(
            children: [
              ...
              // ============================================
              // RIGHT: Export Button (Blue, Rounded)
              // ============================================
              _buildExportButton(),
            ],
          ),
  ...
  // ---------------------------
  // EXPORT BUTTON BUILDER
  // ---------------------------
  /// Builds the rounded blue export button with loading state.
  Widget _buildExportButton() {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          // Blue gradient like CapCut export button
